...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="" src="" alt="" height="60" width="60">
  </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="pro.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>User feedback</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="admin33.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Edit Booking</p>
                </a>
              </li>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <?php
                $connection = mysqli_connect('localhost', 'root', '', 'tours');
                 $result = mysqli_query($connection, "SELECT  COUNT(*) as count FROM order_reg"
                 );
                 while ($row = mysqli_fetch_array($result)) 
                 {
                     $var = $row['count'];
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="gallery.html" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
